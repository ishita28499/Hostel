...
<body  style="background-image:url('img/untitled.png');">
...
<td><a href="javascript:void(0);"  onClick="popUpWindow('http://localhost:89/Hostel1/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print Data</a></td>
</tr>
<tr>

...
if ($_POST['submit']) {
    ...
    $query = "insert into  messtable(regno,typeoffood) values(?,?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('ss', $regno, $typeoffood);
    $stmt->execute();
    $stmt->close();
...
//    $stmt1->execute();
    echo"<script>alert('Mess Successfully Registered');</script>";
}
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="page-title">Book a mess </h2>
                                        ...
                                        <div class="panel-body">
                                            <form method="post" action="" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label"><h4 style="color: green" align="left">Mess Related info </h4> </label>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Reg no. </label>
                                                    <div class="col-sm-8">
                                                        <select name="regno" id="room"class="form-control"  onChange="getSeater(this.value);" onBlur="checkAvailability()" required> 
...
<!--
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="typeoffood" id="duration" class="form-control">
...
-->
                                                ...
                                                <div class="col-sm-6 col-sm-offset-4">
                                                    ...
                                                    <input type="submit" name="submit" Value="Book Mess" class="btn btn-primary">
                                                </div>
                                            </form>

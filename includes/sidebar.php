...
<?php } else { ?>
                ...
                <li><a href="homepage.php"><i class="fa fa-files-o"></i> Home Page</a></li>
                <li><a href="aboutus.php"><i class="fa fa-files-o"></i> About Us</a></li>
...
<li><a href="warden"><i class="fa fa-user"></i> Warden Login</a></li>
<li><a href="contactus.php"><i class="fa fa-files-o"></i> Contact Us</a></li>
				<?php } ?>

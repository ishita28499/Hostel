...
<body  style="background-image:url('img/rnsit.PNG');">

	<div class="login-page bk-img" style="background-image: url(img/rnsit.PNG);">
...
<!-- <p> Brought To You By <a href="">SARITHA RNSIT</p> -->
</footer> </div>

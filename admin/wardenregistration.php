...
$query="insert into  wardentable(wardenno,firstName,middleName,lastName,username, password, gender,contactno,email,City,State,Pincode) values(?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('ssssssssssss',$wardenno,$fname,$mname,$lname,$uname, $pwd, $gender,$contactno,$emailid,$ccity,$cstate,$cpincode);
$stmt->execute();
$stmt->close();
...
<div class="col-sm-8">
<input type="text" name="wardenno" id="wardenno"  class="form-control" required="required" >
</div>
</div>
